...
9. **Nada de dependencias nuevas.** Ni Composer, ni npm, ni CDN de JS. **Única
   excepción, decidida expresamente:** Tesseract.js por CDN, solo en
   `pegado.php`, para el reconocimiento de capturas — ver
   `.claude/rules/dashboard.md`. No es una puerta abierta a más librerías.
